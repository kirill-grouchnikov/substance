 ...
 */
public class ic_delete_black_24px implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
g.setTransform(defaultTransform_);
	...
	public static ic_delete_black_24px of(int width, int height) {
	   ic_delete_black_24px result = new ic_delete_black_24px();
	   result.width = width;
