 ...
 */
public class ic_home_black_24px implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
((GeneralPath)shape).moveTo(10.0, 20.0);
...
((GeneralPath)shape).lineTo(22.0, 12.0);
((GeneralPath)shape).lineTo(12.0, 3.0);
((GeneralPath)shape).lineTo(2.0, 12.0);
...
g.setTransform(defaultTransform_);
	...
	public static ic_home_black_24px of(int width, int height) {
	   ic_home_black_24px result = new ic_home_black_24px();
	   result.width = width;
