 ...
 */
public class ic_add_circle_black_24px implements Icon, IsResizable, IsHiDpiAware, UIResource {
...
((GeneralPath)shape).moveTo(17.0, 13.0);
...
((GeneralPath)shape).lineTo(17.0, 11.0);
((GeneralPath)shape).lineTo(17.0, 13.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
	public ic_add_circle_black_24px() {
