 ...
 */
public class ic_view_list_black_24px implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
g.setTransform(defaultTransform_);
	...
	public static ic_view_list_black_24px of(int width, int height) {
	   ic_view_list_black_24px result = new ic_view_list_black_24px();
	   result.width = width;
