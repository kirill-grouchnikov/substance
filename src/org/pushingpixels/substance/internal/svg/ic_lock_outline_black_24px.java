 ...
 */
public class ic_lock_outline_black_24px implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
g.setTransform(defaultTransform_);
	 ...
	 */
	public ic_lock_outline_black_24px() {
	...
	public static ic_lock_outline_black_24px of(int width, int height) {
	   ic_lock_outline_black_24px result = new ic_lock_outline_black_24px();
	   result.width = width;
