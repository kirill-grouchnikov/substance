 ...
 */
public class ic_error_black_24px implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
((GeneralPath)shape).moveTo(13.0, 17.0);
((GeneralPath)shape).lineTo(11.0, 17.0);
((GeneralPath)shape).lineTo(11.0, 15.0);
((GeneralPath)shape).lineTo(13.0, 15.0);
((GeneralPath)shape).lineTo(13.0, 17.0);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(13.0, 13.0);
((GeneralPath)shape).lineTo(11.0, 13.0);
((GeneralPath)shape).lineTo(11.0, 7.0);
((GeneralPath)shape).lineTo(13.0, 7.0);
...
g.setTransform(defaultTransform_);
	...
	public static ic_error_black_24px of(int width, int height) {
	   ic_error_black_24px result = new ic_error_black_24px();
	   result.width = width;
