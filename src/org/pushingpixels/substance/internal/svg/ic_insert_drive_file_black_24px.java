 ...
 */
public class ic_insert_drive_file_black_24px implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
g.setTransform(defaultTransform_);
	...
	public static ic_insert_drive_file_black_24px of(int width, int height) {
	   ic_insert_drive_file_black_24px result = new ic_insert_drive_file_black_24px();
	   result.width = width;
