 ...
 */
public class ro implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
((GeneralPath)shape).lineTo(213.333, 0.0);
((GeneralPath)shape).lineTo(213.333, 480.0);
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(213.333, 0.0);
((GeneralPath)shape).lineTo(426.666, 0.0);
((GeneralPath)shape).lineTo(426.666, 480.0);
((GeneralPath)shape).lineTo(213.333, 480.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(426.666, 0.0);
