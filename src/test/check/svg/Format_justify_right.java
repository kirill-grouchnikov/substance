 ...
 */
public class Format_justify_right implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
g.setTransform(defaultTransform_);
	...
	public static Format_justify_right of(int width, int height) {
	   Format_justify_right result = new Format_justify_right();
	   result.width = width;
