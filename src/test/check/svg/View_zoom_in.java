 ...
 */
public class View_zoom_in implements Icon, UIResource, IsResizable, IsHiDpiAware {
	/**
...
g.setTransform(defaultTransform_);
	...
	public static View_zoom_in of(int width, int height) {
	   View_zoom_in result = new View_zoom_in();
	   result.width = width;
