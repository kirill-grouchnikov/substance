...
g.setTransform(defaultTransform_);
	...
	public static Process_stop of(int width, int height) {
	   Process_stop result = new Process_stop();
	   result.width = width;
